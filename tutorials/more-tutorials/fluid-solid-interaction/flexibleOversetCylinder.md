...
```note
This case is no longer part of the solids4foam repository. It was included up
to and including **v2.4**, and was removed afterwards: solids4foam's preCICE
cases are maintained upstream in
...
See
[Using solids4foam with preCICE](https://www.solids4foam.com/tutorials/more-tutorials/fluid-solid-interaction/preCICE.html)
for the cases that are maintained and tested.
```
...
![Diagram showing the fluid and solid meshes](images/flexibleOversetCylinderMesh.webp)
...
You can see these modifications in the archived case linked above, under
`fluidSolidInteraction-preCICE/flexibleOversetCylinder`.
...
![Diagram of the mesh](./images/flexibleOversetCylinderDeformedRing.webp)
